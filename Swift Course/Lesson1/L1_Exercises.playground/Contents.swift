...
let yourSentence = "The \(nounArray[0]) like to look at the \(nounArray[2]) and motivate it's owner who is a \(nounArray[6])."
let yourSillySentence = "We are the random \(nounArray[index1]) and we love \(nounArray[index2])."
//: ### Exercise 2
...
var characters = howManyCharacters.characters.count
//: ### Exercise 4
...
for element in dictionary{
    newestString = newestString.replacingOccurrences(of: element.key, with: element.value)
}
//: ### Exercise 8
...
var solutionDollars = numOfPennies/100
var solutionCents = numOfPennies%100
var solutionString = "$\(solutionDollars).\(solutionCents)"
